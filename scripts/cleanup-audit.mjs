...
function explicitTargets() {
  const targets = [
    ...
    { path: "database/063_session_participants_fk_fix.sql", preBucket: "DO_NOT_DELETE",
      note: "Renamed from 010_fix_cross_store_fk.sql (cleanup-001) — prefix 010 was shared, now unique at 063. Idempotent DROP CONSTRAINT IF EXISTS." },
    { path: "database/010_session_participant_manager.sql", preBucket: "DO_NOT_DELETE",
      note: "Original 010; keeps position after cleanup-001 renamed the duplicate to 063." },
