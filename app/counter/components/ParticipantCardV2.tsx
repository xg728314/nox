    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="w-5 h-5 rounded-full bg-red-500/70 hover:bg-red-500 text-white text-[10px] flex items-center justify-center flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity"
          title="삭제"
        >✕</button>
      </div>
    )
