...
/**
 * ForeignWorkersPanel — 다른 가게 아가씨 (진행중인 방만).
 *
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-1 mb-2 flex items-center justify-between">
        <span className="text-[11px] text-slate-100 font-bold">다른 가게 아가씨 <span className="text-slate-500 font-normal">(진행중인 방만)</span></span>
