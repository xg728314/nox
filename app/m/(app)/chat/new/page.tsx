...
export default function ChatNewPage() {
  ...
  // 2026-06-12 R-cross-store-group: 백엔드가 매장 제약 풀림.
  //   어느 매장 멤버든 그룹 채팅 초대 가능. 매장명/층은 정보 표시만.
  ...
  // 선택한 멤버 중 타 매장 개수 — 참고 정보 (경고가 아닌 표시)
      ...
      <div className="px-5 pb-4 flex-1 flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between px-1">
          <div className="text-[10px] font-extrabold text-[#7A746A] uppercase tracking-wider">
            ...
            {crossStoreSelected > 0 && (
              <span className="ml-1.5 text-[#A87D45] normal-case">
                · 타 매장 {crossStoreSelected}명
              </span>
            )}
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-[#D8D2C8]/60 overflow-hidden max-h-[380px] overflow-y-auto">
          ...
          {list.map((h, i) => {
            ...
            const isMine = myStoreUuid != null && h.store_uuid === myStoreUuid
            return (
              <button
                key={h.membership_id}
                type="button"
              ...
              >
                ...
                <div className="text-[10px] font-semibold text-[#7A746A] flex items-center gap-1">
                  {isMine && (
